  ...
  return (
    <main className="mx-auto max-w-7xl space-y-10 px-5 py-10">
      <div className="flex items-center bg-secondary md:h-96">
        <div className="space-y-10 p-10 text-center md:w-1/2">
...
function LoadingSkeleton() {
  return (
    <div className="lg:grid-cols- flex grid-cols-2 flex-col gap-5 pt-12 sm:grid md:grid-cols-3 lg:grid-cols-4">
